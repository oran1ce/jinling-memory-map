...
-- ALTER ROLE "authenticator" WITH NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:nYYNqbZdT0aXdx5WneoLOQ==$/Z5gy+Hkl5s6G3qA5pZxuF5+ZZd+CemJHWTYPNohZQI=:jlG/2UuhH8GHYfkftWw/ys48Dk+cQzquPspTM9vxWv4=';
-- CREATE ROLE "dashboard_user";
-- ALTER ROLE "dashboard_user" WITH INHERIT CREATEROLE CREATEDB NOLOGIN REPLICATION NOBYPASSRLS;
-- CREATE ROLE "pgbouncer";
-- ALTER ROLE "pgbouncer" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:YafsjWo1eOSHINErowJ4DQ==$SFGhRhKnctZxJaRf8gmAKqiPQ0A0OsRlok3AB93GQVI=:4b9D+6A0cb2DIxzHmkfMXIsf+XxAhUs3MvEsHyPx4n8=';
-- CREATE ROLE "postgres";
-- ALTER ROLE "postgres" WITH INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:/fYebVZqbwmcsUbYN9gw8g==$HyeHa+si6Fd2lVEy9lMwu5dsBYSF10GR66U7UNR1PfI=:fgsggzP+bBa8wNJoxM8dYC2rVkAp7j5AjAqNTjV9AXk=';
-- CREATE ROLE "service_role";
-- ALTER ROLE "service_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN BYPASSRLS;
-- CREATE ROLE "supabase_admin";
-- ALTER ROLE "supabase_admin" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:0GGIlBt1MBTDBnv18CWkIw==$9kFEVIKJSDM356M1+JYEE5SoVDTcwicfTcCala5++hA=:cZcTyJHi6BTXahJKxAGuRUohRhvkf/0qYk0beU4IvPM=';
-- CREATE ROLE "supabase_auth_admin";
-- ALTER ROLE "supabase_auth_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:WOE9lBO71tAbg20pJ2Gl2g==$U1Y/wJCTgpb8mxOJkVG+bpNuHS8M7AjEgdz/3Hs29Qk=:bi8kJz9Z4A4ecAeIEX7VASzMJTMnzzfksRl9V6OjOHs=';
-- CREATE ROLE "supabase_functions_admin";
-- ALTER ROLE "supabase_functions_admin" WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:NCdzUPLC6LaSRWkVA37ZZA==$oa5J/hfWg73drRkzI1CqwnsJm2PE+poPNYnmBNm29Vc=:JPH4ofEoZHOxZ5fRKjVK8mRreVUQN9U8fTdIwqPn4W4=';
...
-- ALTER ROLE "supabase_storage_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:Af8o0dXcZo3bHcaArH/Q+Q==$t8Pe+bA8SA0nb7xcYUpaNt2xg9MCQwCuO0cFHWZd/N8=:+Fxti8z+0i0KvUr1jiiTJ3rHnRLkyTGZqrp5ZXiQBaQ=';
...
--
-- Name: marker_connections; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."marker_connections" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "from_marker_id" "uuid" NOT NULL,
    "to_marker_id" "uuid" NOT NULL,
...
--
-- Name: marker_photos; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: favorites favorites_user_id_marker_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."favorites"
    ADD CONSTRAINT "favorites_user_id_marker_id_key" UNIQUE ("user_id", "marker_id");
...
--
-- Name: likes likes_user_id_marker_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."likes"
    ADD CONSTRAINT "likes_user_id_marker_id_key" UNIQUE ("user_id", "marker_id");


--
-- Name: marker_connections marker_connections_from_marker_id_to_marker_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."marker_connections"
    ADD CONSTRAINT "marker_connections_from_marker_id_to_marker_id_key" UNIQUE ("from_marker_id", "to_marker_id");


--
-- Name: marker_connections marker_connections_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."marker_connections"
    ADD CONSTRAINT "marker_connections_pkey" PRIMARY KEY ("id");


--
-- Name: marker_photos marker_photos_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."marker_photos"
    ADD CONSTRAINT "marker_photos_pkey" PRIMARY KEY ("id");
...
--
-- Name: favorites favorites_marker_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."favorites"
    ADD CONSTRAINT "favorites_marker_id_fkey" FOREIGN KEY ("marker_id") REFERENCES "public"."markers"("id") ON DELETE CASCADE;
...
--
-- Name: likes likes_marker_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."likes"
    ADD CONSTRAINT "likes_marker_id_fkey" FOREIGN KEY ("marker_id") REFERENCES "public"."markers"("id") ON DELETE CASCADE;
...
--
-- Name: marker_connections marker_connections_from_marker_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."marker_connections"
    ADD CONSTRAINT "marker_connections_from_marker_id_fkey" FOREIGN KEY ("from_marker_id") REFERENCES "public"."markers"("id") ON DELETE CASCADE;


--
-- Name: marker_connections marker_connections_to_marker_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."marker_connections"
    ADD CONSTRAINT "marker_connections_to_marker_id_fkey" FOREIGN KEY ("to_marker_id") REFERENCES "public"."markers"("id") ON DELETE CASCADE;


--
-- Name: marker_photos marker_photos_marker_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."marker_photos"
    ADD CONSTRAINT "marker_photos_marker_id_fkey" FOREIGN KEY ("marker_id") REFERENCES "public"."markers"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."markers"
    ADD CONSTRAINT "markers_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
--
-- Name: favorites favorites_select_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "favorites_select_all" ON "public"."favorites" FOR SELECT TO "authenticated", "anon" USING (true);
...
--
-- Name: marker_connections; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."marker_connections" ENABLE ROW LEVEL SECURITY;

--
-- Name: marker_connections marker_connections_delete_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "marker_connections_delete_own" ON "public"."marker_connections" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."markers"
  WHERE (("markers"."id" = "marker_connections"."from_marker_id") AND ("markers"."user_id" = "auth"."uid"())))));


--
-- Name: marker_connections marker_connections_insert_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "marker_connections_insert_own" ON "public"."marker_connections" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."markers"
  WHERE (("markers"."id" = "marker_connections"."from_marker_id") AND ("markers"."user_id" = "auth"."uid"())))));


--
-- Name: marker_connections marker_connections_select_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "marker_connections_select_all" ON "public"."marker_connections" FOR SELECT TO "authenticated", "anon" USING (true);


--
-- Name: marker_photos; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."marker_photos" ENABLE ROW LEVEL SECURITY;

--
-- Name: marker_photos marker_photos_delete_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "marker_photos_delete_own" ON "public"."marker_photos" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."markers"
  WHERE (("markers"."id" = "marker_photos"."marker_id") AND ("markers"."user_id" = "auth"."uid"())))));


--
-- Name: marker_photos marker_photos_insert_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "marker_photos_insert_own" ON "public"."marker_photos" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."markers"
  WHERE (("markers"."id" = "marker_photos"."marker_id") AND ("markers"."user_id" = "auth"."uid"())))));


--
-- Name: marker_photos marker_photos_select_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "marker_photos_select_all" ON "public"."marker_photos" FOR SELECT TO "authenticated", "anon" USING (true);
...
--
-- Name: markers markers_delete_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "markers_delete_own" ON "public"."markers" FOR DELETE TO "authenticated" USING (("auth"."uid"() = "user_id"));


--
-- Name: markers markers_insert_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "markers_insert_own" ON "public"."markers" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "user_id"));


--
-- Name: markers markers_select_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "markers_select_all" ON "public"."markers" FOR SELECT TO "authenticated", "anon" USING (true);


--
-- Name: markers markers_update_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "markers_update_own" ON "public"."markers" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
--
-- Name: objects avatars_storage_delete_own; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "avatars_storage_delete_own" ON "storage"."objects" FOR DELETE TO "authenticated" USING (("bucket_id" = 'avatars'::"text"));


--
-- Name: objects avatars_storage_insert_own; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "avatars_storage_insert_own" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK (("bucket_id" = 'avatars'::"text"));


--
-- Name: objects avatars_storage_public; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "avatars_storage_public" ON "storage"."objects" FOR SELECT TO "authenticated", "anon" USING (("bucket_id" = 'avatars'::"text"));
...
--
-- Name: objects marker_photos_storage_insert; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "marker_photos_storage_insert" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK (("bucket_id" = 'marker-photos'::"text"));


--
-- Name: objects marker_photos_storage_public; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "marker_photos_storage_public" ON "storage"."objects" FOR SELECT TO "authenticated", "anon" USING (("bucket_id" = 'marker-photos'::"text"));
...
--
-- Name: supabase_realtime marker_connections; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."marker_connections";


--
-- Name: supabase_realtime marker_photos; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."marker_photos";


--
-- Name: supabase_realtime markers; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."markers";
...
marker-photos	marker-photos	\N	2026-05-31 12:05:52.442765+00	2026-05-31 12:05:52.442765+00	t	f	\N	\N	\N	STANDARD
avatars	avatars	\N	2026-06-06 02:18:53.825153+00	2026-06-06 02:18:53.825153+00	t	f	\N	\N	\N	STANDARD
\.
