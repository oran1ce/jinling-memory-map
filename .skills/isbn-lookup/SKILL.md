...
- **Endpoint**：`POST https://app-c0n8991zihhd-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-c0n8991zihhd-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
