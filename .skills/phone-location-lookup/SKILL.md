...
- **Endpoint**：`POST https://app-c0n8991zihhd-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area`
...
async function queryMobileLocation(
  ...
  const url = new URL("https://app-c0n8991zihhd-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area");
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl = new URL("https://app-c0n8991zihhd-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area");
