...
| 接口 | 方法 | Endpoint |
|------|------|----------|
| 提交任务 | POST | `https://app-c0n8991zihhd-api-ra5EZDjVKkXa-gateway.appmiaoda.com/image-generation/submit` |
| 查询状态 | POST/GET | `https://app-c0n8991zihhd-api-VaOwP2jDmAga-gateway.appmiaoda.com/image-generation/task` |
