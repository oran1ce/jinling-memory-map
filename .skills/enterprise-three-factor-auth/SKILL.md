...
- **Endpoint**: `GET https://app-c0n8991zihhd-api-Aa2PZnjE80BL-gateway.appmiaoda.com/company_three/get`
...
async function verifyCompanyThreeFactors(
  ...
  const response = await fetch(
    `https://app-c0n8991zihhd-api-Aa2PZnjE80BL-gateway.appmiaoda.com/company_three/get?${params.toString()}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json;charset=UTF-8",
...
- **third_part_domain**: `app-c0n8991zihhd-api-Aa2PZnjE80BL-gateway.appmiaoda.com`
