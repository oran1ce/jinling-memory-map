...
- **Endpoint**：`GET https://app-c0n8991zihhd-api-79jK62Ze2pQL-gateway.appmiaoda.com/location/ip`
...
async function callIpLocation(
  ...
  const url = `https://app-c0n8991zihhd-api-79jK62Ze2pQL-gateway.appmiaoda.com/location/ip${
...
serve(async (req: Request): Promise<Response> => {
  ...
  if (ip) params.set("ip", ip);
  if (coor) params.set("coor", coor);
  const upstreamUrl = `https://app-c0n8991zihhd-api-79jK62Ze2pQL-gateway.appmiaoda.com/location/ip${
    params.toString() ? "?" + params.toString() : ""
  }`;
